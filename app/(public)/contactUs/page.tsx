  ...
  return (
    <>
      ...
      <div className="w-full flex flex-col md:flex-row px-5 md:px-20 py-10 space-y-10 ">
        ...
        <Card className="dark:bg-stone-700 md:w-1/2 border-t-4 border-t-cyan-500 shadow-lg">
      ...
      <div className="px-5 md:px-20 pb-10 space-y-5">
        ...
        <Card className="dark:bg-stone-700 border-t-4 border-t-cyan-500 shadow-lg">
          <CardContent>
            <Accordion
              type="single"
              collapsible
