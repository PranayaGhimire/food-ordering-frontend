    ...
    <div className="flex flex-col gap-8 px-5 md:px-20 pb-20">
      ...
      <div className="flex flex-col items-center lg:flex-row gap-8">
        {testimonials.map((t) => (
          <Card
            key={t.name}
            className="dark:bg-stone-700 w-full max-w-md h-80 flex flex-col items-center justify-evenly  shadow-md border-t-4 border-t-cyan-500 hover:-translate-y-5 transition-all duration-400"
          >
